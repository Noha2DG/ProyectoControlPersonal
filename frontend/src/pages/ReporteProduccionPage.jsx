...
import { exportarReporteProduccion } from "../utils/exportExcel.js";
...
export default function ReporteProduccionPage() {
  ...
  const totalProcesadoTalla = (reporte?.porTalla ?? []).reduce((s, t) => s + t.Procesado, 0);
  ...
  return (
    <div>
      {/* Filtros */}
      <div className="flex flex-wrap items-end gap-3 mb-5 bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
        <div>
        ...
        {reporte && (
          <button onClick={() => exportarReporteProduccion(reporte.porLote, reporte.porTalla, desde, hasta)}
            className="ml-auto bg-green-600 text-white text-sm font-semibold px-4 py-2 rounded-lg hover:bg-green-700 transition">
            Exportar Excel
          </button>
        )}
      </div>
        ...
        <>
          ...
          <div className="grid grid-cols-4 gap-3 mb-5">
            <div className="bg-white rounded-xl shadow px-4 py-3 text-center">
              ...
              <p className="text-xl font-bold text-gray-800">{reporte.totales.PesoIngreso.toFixed(2)} kg</p>
            </div>
            <div className="bg-white rounded-xl shadow px-4 py-3 text-center">
              <p className="text-xs text-gray-400">Procesado</p>
              <p className="text-xl font-bold text-blue-700">{reporte.totales.Procesado.toFixed(2)} kg</p>
            </div>
            <div className="bg-white rounded-xl shadow px-4 py-3 text-center">
              <p className="text-xs text-gray-400">Pendiente</p>
              <p className="text-xl font-bold text-amber-600">{reporte.totales.Pendiente.toFixed(2)} kg</p>
            </div>
            <div className="bg-white rounded-xl shadow px-4 py-3 text-center">
              <p className="text-xs text-gray-400">Rendimiento</p>
              <p className="text-xl font-bold text-gray-700">{reporte.totales.Rendimiento.toFixed(1)}%</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-5">
            ...
            <div className="min-w-0">
              <h3 className="text-sm font-semibold text-gray-700 mb-2">Procesado por Talla</h3>

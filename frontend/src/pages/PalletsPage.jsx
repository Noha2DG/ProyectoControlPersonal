                  ...
                  <tbody>
                    {pallet?.Masters.map(m => (
                      <tr key={m.MasterId} className="border-t border-gray-100">
                        ...
                        <td className="px-3 py-2 whitespace-nowrap">{m.DescripcionProceso} {m.Talla} {m.DescripcionPresentacion}</td>
                    ...
                    {pallet?.Masters.length === 0 && (
                      <tr><td colSpan={abierto ? 7 : 6} className="px-3 py-6 text-center text-gray-400">Sin masters escaneados todavía</td></tr>
                    )}
                  </tbody>
                </table>
              </div>
